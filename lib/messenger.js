...
function Messenger(hardware) {
  ...
  this.bgLib = new bluegiga.bglib();

  this.bgLib.setPacketMode(1);

  // Clear the parser buffer
  this.bgLib.resetParser();
  ...
  this.commandPacketTimeoutDuration = 8000;
...
Messenger.prototype.verifyCommunication = function(callback) {
  this.execute(this.bgLib.api.systemHello, callback);
}

// Messenger.prototype.startScanning = function(callback) {
//   this.execute(this.bgLib.api.gapDiscover, [this.bgLib.GAPDiscoverMode.gap_discover_generic], callback);
// }

// Messenger.prototype.stopScanning = function(callback) {
//   this.execute(this.bgLib.api.gapEndProcedure, callback);
// }

// Messenger.prototype.discoverService = function(peripheral, uuid, callback) {
//   this.execute(this.bgLib.api.attClientFindByTypeValue, [peripheral.connection, 0x0001, 0xFFFF, uuid, []], callback);
// }

// Messenger.prototype.startAdvertising = function(callback) {
//   this.execute(this.bgLib.api.gapSetMode, [this.bgLib.GAPDiscoverableModes.gap_general_discoverable, this.bgLib.GAPConnectableMode.gap_directed_connectable], callback);
// }

// Messenger.prototype.writeValue = function(handle, value, callback) {
//   var self = this;
//   this.execute(this.bgLib.api.attributesWrite, [handle, 0, value], function(err, response) {
...
//   this.execute(this.bgLib.api.gapConnectDirect, [address, address_type, 25, 50, 500, 8], callback);
// }
// Messenger.prototype.disconnect = function(connection, callback) {
//   // params: address, address_type, conn_interval_min, conn_interval_max, timeout, latency
//   // TODO: Make last four params configurable?
//   this.execute(this.bgLib.api.connectionDisconnect, [connection], callback);
// }

// Messenger.prototype.readValue = function(handle, callback) {
//   var self = this;
//   // Execute the read
//   this.execute(this.bgLib.api.attributesRead, [handle, 0], function(err, response) {
...
//   this.execute(this.bgLib.api.systemAddressGet, [], callback);
// }

// Messenger.prototype.whitelistAppend = function(address, callback) {
//   this.execute(this.bgLib.api.systemWhitelistAppend, [address, 0], callback);
// }
// Messenger.prototype.clearWhitelist = function(callback) {
//   this.execute(this.bgLib.api.systemWhiteListClear, [], callback);
// }

// Messenger.prototype.connectSelective = function(callback) {
//   this.execute(this.bgLib.api.gapConnectSelective, [25, 50, 500, 8], callback);
// }

// Messenger.prototype.setAdvertisementData = function(advOrScan, data, callback) {
//   this.execute(this.bgLib.api.gapSetAdvData, [advOrScan, data], callback);
// }

// Messenger.prototype.discoverAllServices = function(peripheral, callback) {
//   this.execute(this.bgLib.api.attClientReadByGroupType, [peripheral.connection, 00001, 0xFFFF, [0x00, 0x28]], callback);
// }
// Messenger.prototype.discoverCharacteristics = function(peripheral, start, end, callback) {
//   this.execute(this.bgLib.api.attClientFindInformation, [peripheral.connection, start, end], callback);
// }

// Messenger.prototype.updateRssi = function(peripheral, callback) {
//   this.execute(this.bgLib.api.connectionGetRSSI, [peripheral.connection], callback);
// }

// Messenger.prototype.readRemoteHandle = function(peripheral, uuid, callback) {
//   this.execute(this.bgLib.api.attClientReadByType, [peripheral.connection, 0x0001, 0xFFFF, [0xFF, 0xA6]], callback);
// };
