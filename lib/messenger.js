...
Messenger.prototype.discoverAllServices = function(peripheral, callback) {
  this.execute(bgLib.api.attClientReadByGroupType, [peripheral.connection, 00001, 0xFFFF, 0x2800], callback);
}
...
Messenger.prototype.readRemoteHandle = function(peripheral, uuid, callback) {
  this.execute(bgLib.api.attClientReadByType, [peripheral.connection, 0x0000, 0xFFFF, [0xFF, 0xA6]], callback);
};
