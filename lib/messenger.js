...
Messenger.prototype.discoverServices = function(peripheral, callback) {
  this.execute(bglib.api.attClientReadByGroupType, [peripheral.connection, 0x0001, 0xFFFF, [0x00, 0x28]], callback);
}

Messenger.prototype.discoverAllCharacteristics = function(peripheral, callback) {
  this.execute(bglib.api.attClientFindInformation, [peripheral.connection, 0x0001, 0xFFFF], callback);
}

Messenger.prototype.discoverCharacteristicsInRange = function(peripheral, startHandle, endHandle, uuid, callback) {
  this.execute(bglib.api.attClientReadByType, [peripheral.connection, startHandle, endHandle, uuid], callback);
}

Messenger.prototype.findUUID = function(peripheral, characteristic, callback) {
  this.execute(bglib.api.attClientFindInformation, [peripheral.connection, characteristic.handle, characteristic.handle + 1], callback);
}
...
Messenger.prototype.writeImmediately = function(characteristic, buf, callback) {
  this.execute(bglib.api.attClientAttributeWrite, [characteristic._peripheral.connection, characteristic.handle, buf], callback);
}

Messenger.prototype.prepareWrite = function(characteristic, buf, offset, callback) {
  this.execute(bglib.api.attClientPrepareWrite, [characteristic._peripheral.connection, characteristic.handle, offset, buf], callback);
}

Messenger.prototype.executeWrite = function(characteristic, callback) {
  this.execute(bglib.api.attClientExecuteWrite, [characteristic._peripheral.connection, 1], callback);
}

Messenger.prototype.cancelWrite = function(characteristic, callback) {
  this.execute(bglib.api.attClientExecuteWrite, [characteristic._peripheral.connection, 0], callback);
}
