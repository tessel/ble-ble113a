...
Messenger.prototype.writeLocalValue = function(handle, value, callback) {
  this.execute(bglib.api.attributesWrite, [handle, 0, value], callback);
}

Messenger.prototype.readLocalValue = function(handle, offset, callback) {
...
Messenger.prototype.writePin = function(port, pinMask, callback) {
  this.execute(bglib.api.hwIOPortWrite, [port, pinMask, pinMask], callback);
}
...
Messenger.prototype.setPinFunctions = function(port, func, callback) {
  this.execute(bglib.api.hwIOPortConfigFunction, [port, func], callback);
}
