...
function Messenger(hardware) {
  ...
  this.commandPacketTimeoutDuration = 12000;
...
Messenger.prototype.discoverService = function(peripheral, uuid, callback) {
  this.execute(bglib.api.attClientFindByTypeValue, [peripheral.connection, 0x0001, 0xFFFF, uuid, []], callback);
}
...
Messenger.prototype.discoverAllServices = function(peripheral, callback) {
  console.log("About to discover all services...");
