...
Messenger.prototype.discoverCharacteristicsInRange = function(peripheral, startHandle, endHandle, callback) {
  this.execute(bglib.api.attClientReadByType, [peripheral.connection, startHandle, endHandle, [0x03, 0x28]], callback);
}

Messenger.prototype.findUUID = function(peripheral, characteristic, callback) {
  this.execute(bglib.api.attClientFindInformation, [peripheral.connection, characteristic.handle, characteristic.handle], callback);
}
