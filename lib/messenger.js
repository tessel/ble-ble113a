...
Messenger.prototype.findHandle = function(peripheral, offset, callback) {
  this.execute(bglib.api.attClientFindInformation, [peripheral.connection, offset, offset+1], callback);
}
...
Messenger.prototype.readHandle = function(peripheral, handle, callback) {
  this.execute(bglib.api.attClientReadByHandle, [peripheral.connection, handle], callback);
}
