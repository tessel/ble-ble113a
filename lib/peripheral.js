...
BluetoothController.prototype.deleteBond = function(callback) {
  this._controller.deleteBond(this, callback);
}

BluetoothController.prototype.startEncryption = function(callback) {
  this._controller.startEncryption(this, callback);
}

BluetoothController.prototype.enterPasskey = function(passKey, callback) {
